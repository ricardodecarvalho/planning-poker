...
// Lucide dropped its brand "github" glyph, so this is a self-contained
// currentColor version that adapts to light/dark like the other icons.
const GithubIcon = ({ size = 19 }: GithubIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
